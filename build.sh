...
create_odin_package() {
    ...
    if ! tar -cvf "SavedByLight_${MODEL}_v.${BUILD_KERNEL_VERSION}_Odin_KSUN.tar" boot.img dt.img dtbo.img; then
...
create_twrp_package() {
    ...
    if ! zip -r "SavedByLight_${MODEL}_v.${BUILD_KERNEL_VERSION}_TWRP_KSUN.zip" META-INF boot.img dt.img dtbo.img; then
...
main() {
    ...
    echo "   - SavedByLight_${MODEL}_v.${BUILD_KERNEL_VERSION}_Odin_KSUN.tar"
    echo "   - SavedByLight_${MODEL}_v.${BUILD_KERNEL_VERSION}_TWRP_KSUN.zip"
    echo ""
