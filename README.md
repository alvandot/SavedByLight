<h1 align="center">SavedByLight Kernel for Galaxy S10/Note10 devices.</h1>
...
```
git clone https://github.com/papaL3xa/SavedByLight.git
```

2. Build for your device (To list all build script command run `./build.sh -h`)

```
./build.sh -m [device_model] -v [kernel_version]
```
